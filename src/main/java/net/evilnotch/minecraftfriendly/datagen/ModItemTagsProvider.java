...
public class ModItemTagsProvider extends FabricTagsProvider.ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider registries) {
        ...
        tag(ItemTags.PIGLIN_SAFE_ARMOR).add(ModItems.getRK(ModItems.EMERALD_HELMET));
        tag(ItemTags.PIGLIN_SAFE_ARMOR).add(ModItems.getRK(ModItems.EMERALD_CHESTPLATE));
        tag(ItemTags.PIGLIN_SAFE_ARMOR).add(ModItems.getRK(ModItems.EMERALD_LEGGINGS));
        tag(ItemTags.PIGLIN_SAFE_ARMOR).add(ModItems.getRK(ModItems.EMERALD_BOOTS));
